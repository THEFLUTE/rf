...
define('CAMPAIGN_ID', "bef3b299d462317a354681151dd5bc3e");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'ae338b55c0c9189640da0bf79969efa6');
define('MP_PARAM_NAME', 'gc_clk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '42c163f4bab601e12a687fa348ee5738');
define('CHECK_MCPROXY_VALUE', 'df686000114c239d1f7faeefa2d4a935de6bf7026c98046b657ad0ec2a805822');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '22018.3');
